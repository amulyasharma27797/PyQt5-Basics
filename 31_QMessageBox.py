from PyQt5.QtWidgets import QApplication, QMainWindow, QAction, QMessageBox, QFileDialog, QTextEdit, QFontDialog, QColorDialog
import sys
...
class Window(QMainWindow):
    ...
    def create_menu(self):
        ...
        choiceAction = QAction(QIcon("choice.png"), "Choice Message", self)
        choiceAction.triggered.connect(self.choice_message_box)
    ...
    def choice_message_box(self):
        ...
        if message == QMessageBox.Yes:
            ...
            self.textEdit.setText("No, I don't!")
